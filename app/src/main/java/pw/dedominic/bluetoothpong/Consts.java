...
//    public static final int DEFLECTION_Y = 4;
    public static final int GET_ENEMY_PADDLE = 4;
    ...
    public static final float PADDLE_SPACE_FRACT  = 16;
    public static final float PADDLE_HALFWIDTH_FRACT  = 32;
    public static final float PADDLE_HALFHEIGHT_FRACT = 10;
    public static final float BALL_RADIUS_FRACT = 50;
